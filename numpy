...
print("\n" + "=" * 72)
print("COEFICIENTES ANALITICOS - CASO ORIGINAL")
...
print("\n" + "=" * 72)
print("COEFICIENTES ANALITICOS - CASO MODIFICADO")
print("=" * 72)
for k in [43, 44, 45]:
...
# En el artículo la energia principal queda repartida entre 440 y 450 Hz.
pot1 = np.abs(X1) ** 2
...
# 7. CONVERGENCIA DE LA SERIE DE FOURIER - CASO ORIGINAL
Ks = [45, 60, 100, 300]
print("\n" + "=" * 72)
print("CONVERGENCIA DE LA SERIE - CASO ORIGINAL")
print("=" * 72)
...
# Para la senal modificada, K=44 ya contiene exactamente el armonico necesario.
...
plt.xlabel("Tiempo [ms]")
plt.ylabel("Amplitud")
plt.title("Convergencia de la serie de Fourier - caso original")
plt.grid(True, alpha=0.25)
plt.legend()
plt.tight_layout()
